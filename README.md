...
- [x] 리스트 페이지에서는 등록 버튼이 있고 버튼을 누르면 http://주소:포트/article/create 
- 경로로 이동하고 등록 폼이 나온다.
...
## 미비사(선택)항 or 막힌 부분
- 능력부족으로 인해 검색은 도전해보지 못했습니다.

## UI/UX (화면 캡처본을 복사 붙여 넣기, url 주소 나오도록)
- 게시글 리스트 페이지
- ![게시글 리스트 페이지.jpg](img%2F%EA%B2%8C%EC%8B%9C%EA%B8%80%20%EB%A6%AC%EC%8A%A4%ED%8A%B8%20%ED%8E%98%EC%9D%B4%EC%A7%80.jpg)
...
- 회원가입 페이지
![회원가입 페이지.jpg](img%2F%ED%9A%8C%EC%9B%90%EA%B0%80%EC%9E%85%20%ED%8E%98%EC%9D%B4%EC%A7%80.jpg)
